  ...
  return (
    <Box component="form" onSubmit={onSubmit} sx={{ mt: 2, px: 4 }}>
      <TextField
        ...
        value={task.title}
        onChange={(e) =>
          taskService.setTask({ ...task, title: e.target.value })
        }
        sx={{ mb: 3 }}
      />
      ...
      <TextField
        ...
        onChange={(e) =>
          taskService.setTask({ ...task, description: e.target.value })
        }
        sx={{ mb: 3 }}
      />
      ...
      >
        <StyledFormControl sx={{ minWidth: 200 }}>
          ...
          <StyledSelect
            ...
            onChange={(event) => {
              handleTagChange(event, "category");
            }}
        ...
        <StyledFormControl sx={{ minWidth: 200 }}>
          ...
          <StyledSelect
            ...
            onChange={(event) => {
              handleTagChange(event, "priority");
            }}
